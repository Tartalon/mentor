...
function createModal() {
	...
	city.textContent = answers.city;
	name.textContent = answers.name + ' ' + answers.surname;
	phone.textContent = answers.phone;
	comments.textContent = answers.comments;
	width.textContent = answers.width + 'm';
	height.textContent = answers.height + 'm';
	weight.textContent = answers.weight + 'kg';
...
function getDeliveryDate() {
	...
	let month = 1;
	if (afterThreeDays.getMonth() + 1 < 10) {
		month = '0' + (afterThreeDays.getMonth() + 1);
	} else {
		month = afterThreeDays.getMonth() + 1;
	}
